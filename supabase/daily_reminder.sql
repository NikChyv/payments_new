...
-- потому что в письме теперь есть личные задачи, а они у каждого свои.
-- Заполняется вручную, один раз:
--
--   update staff set telegram_id = 670574684 where name = 'Никита';
--   update staff set telegram_id = 744619432 where name = 'Валентина';
--   update staff set telegram_id = <chat_id> where name = 'Татьяна';
--
